...
export async function optionalFinancialOverview(client:SupabaseClient,userId:string){try{return await loadFinancialControl(client,userId);}catch{return null;}}
