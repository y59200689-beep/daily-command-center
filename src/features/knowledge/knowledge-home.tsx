...
export function KnowledgeHome() {
  ...
  const load = useCallback(async () => { setError(""); const response = await fetch("/api/knowledge", { cache: "no-store" }); const body = await response.json(); if (response.ok) setData(body.overview); else setError(body.error ?? "Knowledge could not be loaded."); }, []);
